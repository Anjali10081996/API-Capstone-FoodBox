...
public class ProductControllerTest {
	...
	public void getEntityProducts_withoutfilters_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/product/getproducts").accept(MediaType.APPLICATION_JSON);
	...
	public void getProduct_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/product/getproduct/"+prod1.getId()).accept(MediaType.APPLICATION_JSON);
	...
	public void addProduct_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/product/addproduct?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(prod2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void addProduct_fail()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/product/addproduct?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(null)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateProduct_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/product/updateproduct/"+prod2.getId()+"?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(prod2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateProduct_fail()throws Exception {
		...
		prod2.setName("Veg Enchiladas");
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/product/updateproduct/"+prod2.getId()+"?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(null)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateProduct_fail_idmismatch()throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/product/updateproduct/3"+"?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(prod2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void deleteProduct_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/v1/product/deleteproduct/"+prod2.getId()+"?userName="+user.getUsername()).accept(MediaType.APPLICATION_JSON);
