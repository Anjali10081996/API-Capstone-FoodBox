...
public class UserControllerTest {
	...
	public void getEntityUsers_withoutfilters_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/user/getusers").accept(MediaType.APPLICATION_JSON);
	...
	public void getUser_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/user/getuser/"+user1.getId()).accept(MediaType.APPLICATION_JSON);
	...
	public void addUser_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/user/adduser/").accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(user2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void addUser_fail()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/user/adduser/").accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(null)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateUser_success()throws Exception {
		...
		user2.setRole("user");
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/user/updateuser/"+user2.getId()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(user2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateUser_fail()throws Exception {
		...
		user2.setRole("user");
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/user/updateuser/"+user2.getId()).accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(null)).contentType(MediaType.APPLICATION_JSON);
	...
	public void updateUser_fail_idmismatch()throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/api/v1/user/updateuser/3").accept(MediaType.APPLICATION_JSON).content(this.mapper.writeValueAsString(user2)).contentType(MediaType.APPLICATION_JSON);
	...
	public void deleteUser_success()throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/v1/user/deleteuser/"+user2.getId()).accept(MediaType.APPLICATION_JSON);
